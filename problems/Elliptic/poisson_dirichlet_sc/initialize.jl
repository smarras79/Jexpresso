function initialize(SD::NSD_2D, PT, mesh::St_mesh, inputs, OUTPUT_DIR::String, TFloat)
    ...
    if rank == 0 println(" Initialize fields for the 2D Dirichlet Poisson problem ........................ ") end
    ...
    if rank == 0 println(" Initialize fields for the 2D Dirichlet Poisson problem ........................ DONE") end
