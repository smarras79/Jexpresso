function user_inputs()
  inputs = Dict(
   ...
   #:gmsh_filename         => "./meshes/gmsh_grids/snwp_nonhydro_2000m.msh",
    :gmsh_filename         => "./meshes/gmsh_grids/snwp_nonhydro_400.msh",
      ...
      :mount_type          => "agnesi",
      :a_mount             => 2000.0,
      :h_mount  => 10.0,   # currently 100.0 — needs to be 2.5 km
      :c_mount  => 72000.0,  # currently 0.0 — mountain center at 40 km   
      #---------------------------------------------------------------------------
      # Soundings and data files
      #---------------------------------------------------------------------------
      #:sounding_file       => "./data_files/test_hill_hydro.data", #hydrostatic balanced test_hill_data.
      :sounding_file       => "./data_files/snwp_nonhydro.data", #no_shear data.
     ...
     # :output_dir          => "./SNWP4_400_250",
      :output_dir          => "./SNWP_NH_5_nonhydro_10m",
