...
function user_source!(S, q, qe, npoin, ::CL,::PERT; neqs=1,x=0.0, y=0.0, ymin=0.0, ymax=20000.0, ngl=5, nely=10,xmin = 0.0, xmax=72000.0)
    ...
    #--------------
    zmax = ymax
    zs   = 15000.0      # sponge starts at 15km (top 5km of 20km domain)
    xr   = 62000.0      # 72000 - 10000 (10km lateral sponge on right)
    xl   = 10000.0      # 10km lateral sponge on left
