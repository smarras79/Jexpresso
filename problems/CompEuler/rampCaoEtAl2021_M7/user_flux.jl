...
# ONLY where the state has already left the realizable set.  On this case
# p_inf is 760 Pa and the coldest physical pressure anywhere in the domain
# is p_inf itself (the boundary layer carries dp/dn = 0 and every shock
# RAISES p), so 1e-14 is 16 orders below anything real here.
#
...
# out. At Mach 7.7 that matters far more than at Mach 3, because
#
#     p = (γ-1)(ρE - ½ρ|u|²)
#
...
#
# which is 3.5 at Mach 3 and 17.5 at Mach 7.7 — it grows like M². So the SAME
