#=============================================================================
 LESICP1-imex -- the intercomparison's FREE CONVECTION case (u00, flat).
 ...
 WHAT IT USED TO BE, and why none of it survived:
   * mesh LESICP_128x128x125_10kmX10kmX5km.msh -- does not exist in the repo
     or on Wulver, so the deck could not start.
 ...
 what MOST_U_MIN (0.1 m/s) supports and the Coriolis/geostrophic source has
 U_geo = 0, so it does nothing.
...
function user_inputs()
	...
	# Spin-up is not analysed, so it is dumped coarsely: 1000 s to t = 9000,
	...
	:output_dir          => joinpath(get(ENV, "JEXPRESSO_OUTDIR",
	                                 ...
	                                 "LESICP1_64x64x60_u00_10240mX10240mX5000m_" * String(scheme)) * "/",
