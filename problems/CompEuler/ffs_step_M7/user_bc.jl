#---------------------------------------------------------------------------------
# Boundary conditions for the Mach-7 forward-facing step.
#
...
# expansion fan — its immediate neighbours run at 265-490 m/s on the
# Mach-3 case, and faster here in proportion to the free stream. The flow
# then over-expands around that spurious obstacle until the temperature
# collapses and the pressure goes negative (~t = 3.7e-4 s on the Mach-3
# case, and proportionally sooner at Mach 7 — the corner is the first place
# this deck is expected to fail if it fails at all).
#
