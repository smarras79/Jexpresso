...
// mesh for the forward-facing-step wind tunnel
// (Woodward & Colella 1984; Section 5.1 of Nazarov & Hoffman,
//  Int. J. Numer. Meth. Fluids 2013; 71:339-357).
//
// IDENTICAL to problems/CompEuler/ffs_step/ffs_step_transfinite.geo —
// the geometry does not depend on the Mach number. It is copied here so
// the Mach-7 case is self-contained; only the flow-condition comment
// below differs.
//
...
//
// Flow conditions (this case):
//   Supersonic inflow  M = 7, in SI units: p = 101325 Pa, T = 293 K,
//   rho = 1.20494 kg/m^3, u = 2400.4 m/s  (see initialize.jl).
//   The paper's Section 5.1 nondimensional M = 3 state, for reference:
//     rho = 1.4, m = (4.2, 0), e = 8.8
