function user_inputs()
    ...
    scheme in (:imex, :hevi, :explicit) ||
        error("LESICP2-30x30x60-80m-imex: scheme must be :imex, :hevi or :explicit; got :$scheme")
    #---------------------------------------------------------------------------
	...
	#:gmsh_filename    => "./problems/CompEuler/LESICP2-128x128x60-imex/LESICP_128x128x60_10240mX10240mX5000m.msh",
        :gmsh_filename    => "./problems/CompEuler/LESICP2-30x30x60-80m-imex/LESICP_30x30x60_2400mX2400mX5000m.msh",
	...
	:output_dir          => joinpath(get(ENV, "JEXPRESSO_OUTDIR",
	                                 ...
	                                 "LESICP2_30x30x60_2400mX2400mX5000m_" * String(scheme)) * "/",
