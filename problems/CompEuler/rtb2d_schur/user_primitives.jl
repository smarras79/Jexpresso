...
function user_uout!(ip, ET, uout, u, qe; kwargs...)
    ...
    uout[4] = u[4]/u[1]
    uout[5] = u[5]/u[1]
    # theta perturbation -- THE field to plot for a rising bubble. Named "dθ"
    # in initialize.jl's qoutvars; if you add a slot here, add its name there in
    # the same position or the VTU labels silently stop matching the contents.
