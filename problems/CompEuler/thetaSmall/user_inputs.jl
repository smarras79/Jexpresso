function user_inputs()
    ...
    inputs = Dict(
        ...
        :tinit                => 0.0,
        :tend                 => 100.0,
        :diagnostics_at_times => (0:0.1:100),
        #:restart_time         => 500,
        :lrestart             => false,
        ...
        :μ              => [0.0, 125.0e-4, 125.0e-4, 125.0e-4], #horizontal viscosity constant for momentum
        #---------------------------------------------------------------------------
        # Mesh paramters and files:
        #---------------------------------------------------------------------------
        :lread_gmsh          => true, #If false, a 1D problem will be enforced
        #:gmsh_filename       => "./meshes/gmsh_grids/hexa_TFI_10x10.msh",
        :gmsh_filename       => "./meshes/gmsh_grids/hexa_TFI_32x32_rtb_small.msh",
        #---------------------------------------------------------------------------
        # Filter parameters
        #---------------------------------------------------------------------------
        #:lfilter             => true,
