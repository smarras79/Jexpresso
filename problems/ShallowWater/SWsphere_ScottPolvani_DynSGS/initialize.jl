#---------------------------------------------------------------------------------
# SWsphere_ScottPolvani_DynSGS — initial condition.
#
...
function initialize(SD::NSD_2D, PT, mesh::St_mesh, inputs, OUTPUT_DIR::String, TFloat)
    ...
    if (inputs[:backend] == CPU())
        ...
        error(" # ERROR problems/ShallowWater/SWsphere_ScottPolvani_DynSGS/initialize.jl: only the CPU backend is implemented.")
    end
