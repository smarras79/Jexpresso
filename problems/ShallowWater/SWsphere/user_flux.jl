#---------------------------------------------------------------------------------
# SWsphere — fluxes of the shallow water equations on a spherical shell.
#
...
# the manifold. Those metric terms do not exist yet — see the README — which is
# why the case still stops at :linit_only.
#---------------------------------------------------------------------------------
