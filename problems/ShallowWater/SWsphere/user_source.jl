#---------------------------------------------------------------------------------
# SWsphere — source terms of the shallow water equations on a spherical shell.
#
...
# VISCOSITY  δν∇²(φu)
# -------------------
# The paper regularizes with ν = 1e5 m²/s, switched by δ. That term is a second
# derivative, not a pointwise source, so it belongs to Jexpresso's viscous path
# (:lvisc => true, :μ => ν) rather than here — see user_inputs.jl.
#---------------------------------------------------------------------------------
