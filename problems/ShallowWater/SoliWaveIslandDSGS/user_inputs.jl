function user_inputs()
    ...
    inputs = Dict(
        ...
        :dsgs_Cmin            => 0.05,
        :dsgs_norms           => "domain",  # residual normalized by the spread over the whole basin (the default; "rank" = this rank's elements only, which makes the answer depend on the partition)
