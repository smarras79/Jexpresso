...
# spatial: periodic
function user_bc_dirichlet!(q::AbstractArray, t::AbstractFloat, tag::String, qbdy::AbstractArray, qe, inputs::Dict)
    nothing
end

# velocity: Dirichlet
function user_bc_dirichlet_extra!(q::AbstractArray, t::AbstractFloat, tag::String, qbdy::AbstractArray, qe, inputs::Dict)
