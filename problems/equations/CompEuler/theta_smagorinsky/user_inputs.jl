function user_inputs()
    ...
    inputs = Dict(
        ...
        #---------------------------------------------------------------------------
        # Smagorinsky LES parameters:
        #---------------------------------------------------------------------------
        :lsmagorinsky         => true,   # Enable Smagorinsky turbulence model
        :C_s                  => 0.18,   # Smagorinsky constant (0.1-0.2, atmospheric: 0.18)
        :Pr_t                 => 0.85,   # Turbulent Prandtl number (0.7-1.0)
        :lmolecular_visc      => true,   # Include molecular viscosity
        :μ_molecular          => 1.8e-5, # Molecular dynamic viscosity [kg/(m·s)]
        :Pr_molecular         => 0.71,   # Molecular Prandtl number
        #---------------------------------------------------------------------------
