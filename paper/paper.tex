...
\item \textbf{High-speed compressible flow:} Sod shock tube, quasi-1D Laval
  nozzle, isentropic vortex.
...
\item \textbf{Radiative transfer:} 2D/3D transport with scattering, coupled to a
  dynamical core for atmospheric radiation.
\item \textbf{Others:} shallow water with wetting/drying, elliptic and Helmholtz
