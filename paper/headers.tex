...
\usepackage{enumitem}
\usepackage{titlesec}
% Tighter section spacing: the JOSS page budget is 3 pages and the heading
% gaps of the stock article class cost the better part of one.
\titlespacing*{\section}{0pt}{2.0ex plus .4ex minus .2ex}{1.0ex plus .2ex}
\titlespacing*{\subsection}{0pt}{1.4ex plus .3ex}{0.7ex plus .2ex}
