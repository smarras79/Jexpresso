...
@testset "JEXPRESSO Examples" begin
    ...
    examples = [
        #("CompEuler", "2d"),  ##old error q_define sembrebbe initialize ln11, now  LoadError: MethodError: no method matching user_bc_dirichlet!(::SubArray{Float64, 1, Matrix{Float64}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}}, true}, ::Float64, ::Float64, ::Float64, ::String, ::Vector{Float64}, ::Float64, ::Float64, ::SubArray{Float64, 1, Matrix{Float64}, Tuple{Int64, Base.Slice{Base.OneTo{Int64}}}, true}, ::Main.Jexpresso.TOTAL)
        #("CompEuler", "dc"),
