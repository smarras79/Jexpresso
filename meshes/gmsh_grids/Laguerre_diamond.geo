...
Point(1) = {0.0, ymin, gridsize};
Point(2) = {xmax, 0.0, gridsize};
Point(3) = {0.0, ymax, gridsize};
Point(4) = {xmin, 0.0, gridsize};
...
//Physical Curve("sides",     2) = {4};
//Physical Curve("free_slip", 2) = {1};
Physical Curve("Laguerre", 3) = {1,2,3,4};
