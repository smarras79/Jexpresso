...
"""
function plot_triangulation(SD::NSD_1D, x, y, q, title::String, fout_name::String) nothing end
...
function plot_triangulation(SD::NSD_3D, x, y, q, title::String, fout_name::String) nothing end
