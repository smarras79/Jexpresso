...
function plot_triangulation(SD::NSD_1D, x, y, q::Array, title::String, OUTPUT_DIR::String; iout=1, nvar=1) nothing end
function plot_triangulation(SD::NSD_3D, x, y, q::Array, title::String, OUTPUT_DIR::String; iout=1, nvar=1) nothing end
