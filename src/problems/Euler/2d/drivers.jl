...
function driver(DT::ContGal,       #Space discretization type
    ...
    solution = time_loop!(sem.QT, sem.PT, sem.mesh, sem.metrics, sem.basis, sem.ω, qp, sem.matrix.M, sem.matrix.De, sem.matrix.Le, Nt, inputs[:Δt], inputs, OUTPUT_DIR, TFloat)
