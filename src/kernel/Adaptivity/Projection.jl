...
function conformity4ncf_mp!(Tabs, qn, qc, qi, qr,
                           qs, qg, Pr, Ps, Pg,
                           S_micro, qsatt,
                           q, q_el_tmp, q_tmp, vaux, g_dss_cache,
                           SD::NSD_3D, QT::Inexact, conn::AbstractArray, mesh, Minv, Je, ω, AD, neqs,
                           q_el, q_el_pro,
                           cache_ghost_p, q_ghost_p,
                           cache_ghost_c, q_ghost_c,
                           interp)
    for var in (Tabs, qn, qc, qi, qr, qs, qg, Pr, Ps, Pg, S_micro, qsatt)
        conformity4ncf_q!(var, q_el_tmp, q_tmp, vaux, g_dss_cache,
                          SD, QT, conn, mesh, Minv, Je, ω, AD,
                          q_el, q_el_pro,
                          cache_ghost_p, q_ghost_p,
                          cache_ghost_c, q_ghost_c,
                          interp)
