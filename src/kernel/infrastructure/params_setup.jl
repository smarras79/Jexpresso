function params_setup(sem,
    ...
    if (sem.mesh.lLaguerre ||
        ...
        params = (backend,
                  ...
                  uprimitive,
                  F, G, H, S,
                  F_surf, S_face, S_flux,
                  M_surf_inv = sem.matrix.M_surf_inv,
                  M_edge_inv = sem.matrix.M_edge_inv,
                  flux_gpu, source_gpu, qbdy_gpu,
                  ...
                  sem.x_original, sem.y_original, sem.z_original,
                  sem.basis, sem.ωb, sem.ω, sem.ξ, sem.mesh, sem.metrics,
