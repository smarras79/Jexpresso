...
function filter!(u, params, SD::NSD_2D,::TOTAL)
  ...
  DSS_rhs!(params.B, params.b, params.mesh.connijk, params.mesh.nelem, params.mesh.ngl, params.neqs, SD, params.AD)
...
function filter!(u, params, t, SD::NSD_2D,::PERT)
  ...
  ### Construct local derivatives for prognostic variables
   ...
   ##(159.84 k allocations: 22.544 MiB) current function total, killed 1/3 of allocations thanks to loop unroll
    ...
    DSS_rhs_laguerre!(params.B_lag, params.b_lag, params.mesh.connijk_lag, params.mesh.nelem_semi_inf, params.mesh.ngl, params.mesh.ngr, params.neqs, SD, params.AD)
