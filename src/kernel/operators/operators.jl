...
function _∇f!(f, neqs, ngl, dψ, ω, Je, dξdx, dξdy, dηdx, dηdy, rhs_el, iel, ::CL, QT::Inexact, SD::NSD_2D, AD::ContGal)
    #
    # ∇f = [∂f∂x, ∂f/∂y]
    #
    for j=1:ngl
...
function _∇f!(f, neqs, ngl, dψ, ω, Je, dξdx, dξdy, dηdx, dηdy, rhs_el, iel, ::CL, QT::Inexact, SD::NSD_3D, AD::ContGal)
    #
    # ∇f = [∂f∂x, ∂f/∂y, ∂f/∂z]
    #
    for k=1:ngl
