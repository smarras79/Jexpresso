...
function rhs!(du, u, params, time)
    ...
    if (backend == CPU())
        ...
        if (params.SD == NSD_1D())
            ...
            JACC.parallel_for(params.mesh.nelem * params.mesh.ngl, build_rhs_jacc!,
                              ...
                              lpert, params.inputs[:lperiodic_1d], params.mesh.npoin_linear, params.mesh.npoin)

            if (params.laguerre)
                params.RHS_lag .= TFloat(0.0)
                JACC.parallel_for(params.mesh.nelem_semi_inf * params.mesh.ngr, build_rhs_jacc!,
                                  params.RHS, u, params.uaux, params.qp.qe, params.mesh.x, TFloat(time),
        ...
        elseif (params.SD == NSD_3D())
            ...
            JACC.parallel_for(params.mesh.nfaces_bdy * params.mesh.ngl^2, apply_boundary_conditions_jacc_3D!,
                              @view(params.uaux[:,:]), @view(u[:]), params.qp.qe,
                              params.mesh.x, params.mesh.y, params.mesh.z, TFloat(time),
            ...
            if (params.inputs[:lmoist])
                ...
                JACC.parallel_for(params.mesh.nelem * params.mesh.ngl^3, _build_precipitation_rhs_jacc_3D_v0!,
                                  params.RHS, @view(params.uaux[:,:]), params.qp.qe,
                                  ...
                                  params.mesh.zmax, params.mesh.zmin, lpert,
                                  params.mp.Pr, params.mp.Ps, params.mp.Pg, params.mp.qi, params.mp.qn,
                                  params.mp.Tabs, params.mp.S_micro, MicroConst)
            end

            if (params.inputs[:case] != "bomex")
                JACC.parallel_for(params.mesh.nelem * params.mesh.ngl^3, _build_rhs_jacc_3D_v0!,
                ...
                JACC.parallel_for(params.mesh.nelem * params.mesh.ngl^3, _build_rhs_jacc_3D_v1!,
                                  params.RHS, params.uaux, params.qp.qe,
                                  params.mesh.x, params.mesh.y, params.mesh.z, params.mesh.connijk,
                                  params.metrics.dξdx, params.metrics.dξdy, params.metrics.dξdz,
                                  params.metrics.dηdx, params.metrics.dηdy, params.metrics.dηdz,
                                  ...
                                  params.metrics.Je, params.basis.dψ, params.ω, params.Minv,
                                  params.flux_gpu, params.source_gpu,
                                  params.mesh.ngl, TInt(params.neqs), PHYS_CONST, params.thermo_params,
                                  params.mesh.xmax, params.mesh.xmin, params.mesh.ymax, params.mesh.ymin,
                                  params.mesh.zmax, params.mesh.zmin, lpert)
            end
            ...
            if (params.inputs[:lvisc])
                ...
                elseif params.VT == SMAG()
                    JACC.parallel_for(params.mesh.nelem * params.mesh.ngl^3, _build_rhs_diff_jacc_3D_smag!,
                                      params.RHS_visc, params.rhs_diffξ_el, params.rhs_diffη_el, params.rhs_diffζ_el,
                                      params.uaux, params.qp.qe, params.source_gpu,
                                      params.mesh.x, params.mesh.y, params.mesh.z, params.mesh.connijk,
                                      params.metrics.dξdx, params.metrics.dξdy, params.metrics.dξdz,
                ...
                if (params.inputs[:case] == "bomex")
                    JACC.parallel_for(params.mesh.nelem * params.mesh.ngl^3, saturation_adjustment_jacc_3D!,
                                      ...
                                      TInt(params.neqs), params.thermo_params, lpert)
                    JACC.parallel_for((params.mesh.npoin, params.neqs), uauxtou_jacc!,
                                      u, params.uaux, params.mesh.npoin, TInt(params.neqs))
                end
        ...
        elseif (params.SD == NSD_2D())
            ...
            if (params.inputs[:lfilter])
                ...
                kf(params.uaux, params.qp.qe, params.B, params.fx, params.fy_t, params.metrics.Je,
                   params.ω, params.ω, params.mesh.connijk, params.Minv,
                ...
                if (params.laguerre)
                    ...
                    kf(params.uaux, params.qp.qe, params.B_lag, params.fx, params.fy_t_lag, params.metrics_lag.Je,
                       params.ω, params.ω_lag, params.mesh.connijk_lag, params.Minv,
            ...
            if (params.laguerre)
                ...
                k(@view(params.uaux[:,:]), @view(u[:]), params.qp.qe,
                  params.mesh.x, params.mesh.y, TFloat(time),
                  params.mesh.connijk_lag, params.qbdy_lag_gpu,
            ...
            if (params.laguerre)
                ...
                k_lag(params.RHS_lag, params.uaux, params.qp.qe,
                      params.mesh.x, params.mesh.y, params.mesh.connijk_lag,
            ...
            if (params.inputs[:lvisc])
                ...
                JACC.parallel_for(params.mesh.nelem * params.mesh.ngl^2, _build_rhs_diff_jacc_2D_v0!,
                                  params.RHS_visc, params.rhs_diffξ_el, params.rhs_diffη_el,
                                  params.uaux, params.qp.qe, params.source_gpu,
                                  params.mesh.x, params.mesh.y, params.mesh.connijk,
                                  params.metrics.dξdx, params.metrics.dξdy,
                                  params.metrics.dηdx, params.metrics.dηdy,
