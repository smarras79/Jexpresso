...
function rhs!(du, u, params, time)
    ...
    if (backend == CPU())
        ...
        elseif (params.SD == NSD_3D())
            ...
            # new_param_set = update_p_ref_theta(TFloat(101325.0))
            ...
            # k(@view(params.RHS[:,:]), @view(params.uaux[:,:]), params.qp.qe, params.mesh.x, params.mesh.y, params.mesh.z, params.mesh.connijk, params.metrics.dξdx, params.metrics.dξdy, params.metrics.dξdz, params.metrics.dηdx, 
              ...
              params.mesh.ngl, TInt(params.neqs), PhysConst, params.param_set_bomex, params.mesh.xmax, params.mesh.xmin, params.mesh.ymax, params.mesh.ymin, params.mesh.zmax, params.mesh.zmin, lpert;
            ...
            if (params.inputs[:lvisc])
                ...
                if (params.inputs[:lbomex])
                    ...
                    k_sa(params.uaux, params.qp.qe, params.mesh.z, params.mesh.connijk, TInt(params.neqs), params.param_set_bomex, lpert;
                    ndrange = (params.mesh.nelem*params.mesh.ngl,params.mesh.ngl,params.mesh.ngl), workgroupsize = (params.mesh.ngl,params.mesh.ngl,params.mesh.ngl))
                    KernelAbstractions.synchronize(backend)
